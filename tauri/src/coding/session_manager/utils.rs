...
mod tests {
    ...
    fn build_resume_command_uses_pushd_for_windows_drive_paths() {
        assert_eq!(
            build_resume_command(
                ...
                "pi resume 11111111-2222-3333-4444-555555555555",
            ),
            "pushd \"D:/GitHub/project with space\" && pi resume 11111111-2222-3333-4444-555555555555"
        );
    }
    ...
    fn build_resume_command_keeps_bare_command_without_project_dir() {
        assert_eq!(
            build_resume_command(None, "pi resume ses_abc123"),
            "pi resume ses_abc123"
        );
    }
